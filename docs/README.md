...
├── plain/    # 우리 퍼저 버전 1 (기본 고도화)
└── alfha/     # 우리 퍼저 버전 2 (사양 기반 고도화)
```

### 2. 버전별 특징

- **plain**: 다중 모드 퍼징 기반 기본 고도화 버전
- **alfha**: 명세 기반 추가 최적화가 적용된 고급 버전
...
# 특정 버전 빌드
make baseline        # 기준 퍼저
make plain   # 기본 고도화 버전
make alfha    # 고급 고도화 버전
